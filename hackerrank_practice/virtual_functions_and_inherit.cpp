/**
 *  @file virtual_functions_and_inherit.cpp
 *  @author Miguel Saavedra (miguel.saavedra@uao.edu.co)
 *  @brief Abstract classes and inherit
 *  @version 0.1
 *  @date 07-23-2020
 *
 *  task: This problem is to get you familiar with virtual functions. Create three classes Person, Professor and Student. 
